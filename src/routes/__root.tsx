...
import { SITE_URL, SEO_KEYWORDS, FAVICON_URL } from "../lib/site";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BETASHINE — Betashine Org. Connect, Learn, Earn." },
      { name: "keywords", content: SEO_KEYWORDS },
      { name: "robots", content: "index, follow, max-image-preview:large" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "BETASHINE — Betashine Org" },
      { property: "og:description", content: "Connect, Learn, Earn." },
